...
public class JavaVisitor {
    ...
    public static Tree solve() {
        ...
        for (int i = 0; i < numNodes - 1; i++) {
            ...
            /* Edges are undirected: hackerrank.unsorted.Add 1st direction */
            ...
            /* Edges are undirected: hackerrank.unsorted.Add 2nd direction */
        ...
        /* Create hackerrank.unsorted.Tree */
        TreeNode root = new TreeNode(values[0], colors[0], 0);
        addChildren(root, 1);
        return root;
    }

    /* Recursively adds children of a hackerrank.unsorted.TreeNode */
